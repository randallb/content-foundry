...
import { type Query__LoginForm__param } from './Query/LoginForm/param_type.ts';
...
export function iso<T>(
  param: T & MatchesWhitespaceAndString<'field Query.LoginForm', T>
): IdentityWithParamComponent<Query__LoginForm__param>;
